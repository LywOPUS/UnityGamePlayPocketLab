     ...
     SubShader
     {
          ...
          {   
             ...
             v2g vert(a2v v)
             {
                 ...
                 output.pos = UnityObjectToClipPos(v.vertex) + float4(0,d2,0,0)*_Hightness;//平面顶点位置
                 ...
                 output.lightDir = normalize(UnityObjectToClipPos(mul(rotation , ObjSpaceLightDir(v.vertex))));//光照方向
                 return output;
            }
